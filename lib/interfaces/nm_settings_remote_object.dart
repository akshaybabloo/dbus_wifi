...
class OrgFreedesktopNetworkManagerSettings extends DBusRemoteObject {
  ...
  OrgFreedesktopNetworkManagerSettings(
    DBusClient client,
    String destination, {
    ...
    updated = DBusRemoteObjectSignalStream(
      ...
      signature: DBusSignature(''),
          ...
          (signal) => OrgFreedesktopNetworkManagerSettingsUpdated(signal),
        );
    ...
    removed = DBusRemoteObjectSignalStream(
      ...
      signature: DBusSignature(''),
          ...
          (signal) => OrgFreedesktopNetworkManagerSettingsRemoved(signal),
        );
  }
  ...
  Future<DBusObjectPath> callGetConnectionByUuid(
    String uuid, {
    bool noAutoStart = false,
    bool allowInteractiveAuthorization = false,
  }) async {
    ...
    var result = await callMethod(
      ...
      [
        DBusDict(
          ...
          DBusSignature('a{sv}'),
          connection.map(
            (key, value) => MapEntry(DBusString(key), DBusDict.stringVariant(value)),
          ),
        ),
      ],
      replySignature: DBusSignature('o'),
